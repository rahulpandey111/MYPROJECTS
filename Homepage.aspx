...
<body>
    ...
    <div>
        <img id="IMG1" src="picture/know.jpg" style="z-index: 106; left: 431px; width: 566px;
            position: absolute; top: 27px" onclick="return IMG1_onclick()" />
        &nbsp;
        <img src="picture/top_r2_c1.gif" style="z-index: 107; left: 2px; width: 200px; position: absolute;
            top: 0px" />
        <img src="picture/top_r5_c2.gif" style="z-index: 108; left: 202px; position: absolute;
            top: 31px" />
        <img src="picture/top_r2_c7.gif" style="z-index: 109; left: 221px; position: absolute;
        ...
        <asp:LinkButton ID="lblstudent" runat="server" EnableTheming="False" PostBackUrl="~/stulogin.aspx"
            Style="z-index: 100; left: 95px; position: absolute; top: 424px" OnClick="LinkButton2_Click">Student</asp:LinkButton>
        <br />
        <br />
        <asp:LinkButton ID="lblcontactus" runat="server" PostBackUrl="~/Contact Us.aspx" Style="z-index: 112;
            left: 79px; position: absolute; top: 464px">Contact Us</asp:LinkButton>
        <br />
        <asp:LinkButton ID="lblhome" runat="server" PostBackUrl="~/Homepage.aspx" Style="z-index: 102;
            left: 99px; position: absolute; top: 393px">Home</asp:LinkButton>
        <br />
        <br />
        <br />
        <br />
        <asp:Panel ID="Panel1" runat="server" Height="345px" Style="z-index: 103; left: 274px;
            ...
            <p>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="font-size: 14pt">
                    <span>CourseFinder helps you locate your ideal university degree course. Quickly complete
                        the study interests<span style="color: #ff9933"> <span style="color: #ff6633">questionnaire,</span></span></span><span
                            style="color: #cc9933"> </span>designed by Morrisby, to pin-point your interests
                    in 150+ degree disciplines.</span></p>
            <p>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="font-size: 14pt">
                    &nbsp;Choose the location, study style, type of university or college and let CourseFinder
        ...
        <p dir="ltr" style="margin-right: 0px">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span style="font-size: 14pt">&nbsp;
                ...
                offered by ustralian &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; universities and higher education
